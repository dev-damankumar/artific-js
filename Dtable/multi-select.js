...
select[multiple] ~ span.select-span span {
    background: #efefef;
    padding: 2px 6px;
    border-radius: 5px;
    font-size: 13px;
...
.theme-5 .option-div.visible.option-selected *,.theme-5 .option-div.visible.option-selected-nulti * {
    color: var(--theme-5-selected-color)
}
                                ...
                                if (!option.hasAttribute("disabled")) {
                                    ...
                                    if (multiple) {
                                        ...
                                        if (!multipleArray.includes(text)) {
                                            ...
                                            console.log(index,multipleArray)
